...
public class Main {
    ...
    static String nomeSaida(String nomeArquivo) {
        ...
        String base = (dot >= 0) ? nomeArquivo.substring(0, dot) : nomeArquivo;
        return PASTA_SAIDA + File.separator + base + "_cocktailsort.txt";
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        File[] arquivos = dir.listFiles(f -> f.isFile() && f.getName().endsWith(".txt"));
        ...
        while (escolha < 1 || escolha > arquivos.length) {
            try {
                ...
                if (escolha < 1 || escolha > arquivos.length) {
                    System.out.printf("Digite um numero entre 1 e %d: ", arquivos.length);
                }
            } catch (NumberFormatException e) {
                System.out.printf("Entrada invalida. Digite um numero entre 1 e %d: ", arquivos.length);
            }
        }
        ...
        System.out.println("\n+=================================================+");
        System.out.printf("|  Arquivo : %-35s  |%n", arquivoEscolhido.getName());
        System.out.println("+=================================================+");
        ...
        imprimirVetor(dados);
        CocktailSort cs = new CocktailSort(dados);
        Estatisticas est = cs.ordenar();
        ...
        System.out.println("  Correto?       : " + (estahOrdenado(dados) ? "SIM" : "ERRO"));
        System.out.println("-------------------------------------------------");
