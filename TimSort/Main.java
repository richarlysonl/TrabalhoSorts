...
/**
 * Main para testar o TimSort com exibição de estatísticas.
 *
 * Lê arquivos da pasta:   dados/
 * Salva resultados em:    dados_ordenados_TimSort/
 *
 * Formato suportado:
 ...
 *
 * Uso:
 *   java Main                        → processa todos os .txt em dados/
 *   java Main dados1000.txt          → processa arquivo específico
 *   java Main arq1.txt arq2.txt ...  → processa múltiplos arquivos
 */
public class Main {

    static final String PASTA_ENTRADA = "dados";
    static final String PASTA_SAIDA   = "dados_ordenados_TimSort";
    ...
    static void testar(String nomeArquivo, List<String[]> resumoGeral) {
        ...
        try {
            ...
            // ── ORDENAÇÃO ─────────────────────────────────────────────────
            Estatisticas est = TimSort.sort(dados);
            // ─────────────────────────────────────────────────────────────
    ...
    public static void main(String[] args) {
        System.out.println("+=================================================+");
        System.out.println("|          TIM SORT - TESTE DE ARQUIVOS           |");
        System.out.println("|  Entrada : dados/                               |");
        System.out.println("|  Saida   : dados_ordenados_TimSort/             |");
        System.out.println("+=================================================+");
        ...
        if (arquivos.isEmpty()) {
            ...
            System.out.println("Uso: java Main                    (todos os arquivos)");
            System.out.println("     java Main dados1000.txt      (arquivo especifico)");
            return;
        }
